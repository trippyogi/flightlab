...
export const modules: ModuleManifest[] = [
  ...
  },
  {
    ...
    title: 'Short',
    status: 'live',
    handles: ['Shot category', 'Pitch lie visual', 'Grass/grain', 'Shot shape', 'Clock swing', 'Loft', 'Bounce', 'Face open', 'Shaft lean', 'Landing spot', 'Firmness'],
    readouts: ['Launch', 'Spin', 'Effective loft', 'Effective bounce', 'Apex', 'Carry', 'Rollout', 'Check', 'Carry-roll'],
    receipts: ['Lie/contact model', 'Grass spin friction', 'Effective bounce/loft model', 'Pelz-style clock matrix', 'Surface rollout model'],
    sources: ['Dave Pelz short-game principles', 'Wedge bounce/fitting conventions', 'TrackMan wedge launch/spin concepts'],
    changelog: ['v0.2: grouped shots as chip/pitch/distance wedge/sand and added pitch lie visuals for sitting-up, sitting-down, flier and tight lies'],
  },
  {
    id: 'gained',
    title: 'Gained',
