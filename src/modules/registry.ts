...
export const modules: ModuleManifest[] = [
  ...
  },
  {
    ...
    title: 'Short',
    status: 'live',
    handles: ['Lie', 'Grass/grain', 'Shot type', 'Clock swing', 'Loft', 'Bounce', 'Face open', 'Shaft lean', 'Landing spot', 'Firmness'],
    ...
    changelog: ['v0.1: added lies/grain, clock swings, effective bounce, miss windows and carry-roll learning cards'],
  },
  {
    id: 'gained',
    title: 'Gained',
